...
// -- Page --------------------------------------------------------------------
//
// Moved here from /agent on 2026-09-09. /agent is now the empty state — what an
// agent is, and that you do not have one — and this is the worked example
// behind it: the only agent actually running, with its real record and its
// losing arms left in. Old `#strategies` links still land correctly; /agent
// forwards any hash it does not own to this page.

export default function OurAgentPage() {
