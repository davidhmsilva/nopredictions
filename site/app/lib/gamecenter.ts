...
// Team-name matching lives in ./teamMatch, because the cross-venue merge needs
// it in the browser too and this module is not something to ship there.
// Re-exported so every existing caller keeps working unchanged.
export { teamScore, fixtureMatches, MIN_SIDE_SCORE } from './teamMatch'
import { teamScore, fixtureMatches, MIN_SIDE_SCORE } from './teamMatch'
